																...
																<div calass="btn-group">
																	<div class="dropdown">
																		...
																		<div class="dropdown-menu">
																			...
																			<a type="submit" href="<?= base_url('Admin/AssetSekolahController/destroyInformasi/') . $data['id'] ?>" class="dropdown-item text-danger" onclick="return confirm('Apakah anda yakin ingin menghapus.?')">
																				Hapus
																			</a>
																		</div>
																	</div>
